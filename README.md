...
- The project currently covers:
  ...
  - Chapter 4, *Set Convergence*, through Exercise 4.48: inner, outer,
    ...
    separability.
  - Chapter 5, *Set-Valued Mappings*, through Exercise 5.30: domains, ranges,
    ...
    and cosmic set limits along an arbitrary index filter, and the convergence
    of images of converging sets.
- Current frontier:
  ...
  - the Chapter 5 ledger classifies all 59 numbered results: 24 exact, two
    documented adaptations, and one partial so far, consecutive from 5.4
    through 5.30, covering formula 5(1), Definition 5.4, the characterizations
    ...
    printed in 5.27 is shown to be false and corrected against 4.20 -- and the
    images of converging sets.
