...
- The project currently covers:
  ...
  - Chapter 4, *Set Convergence*, through Exercise 4.48: inner, outer,
    ...
    separability.
  - Chapter 5, *Set-Valued Mappings*, through Theorem 5.25: domains, ranges,
    ...
    mappings, projections, perturbed mappings, and closedness of images.
- Current frontier:
  ...
  - the Chapter 5 ledger classifies all 59 numbered results: 21 exact and one
    partial so far, consecutive from 5.4 through 5.25, covering formula 5(1),
