...
- The project currently covers:
  ...
  - Chapter 4, *Set Convergence*, through Exercise 4.48: inner, outer,
    ...
    separability.
  - Chapter 5, *Set-Valued Mappings*, through Example 5.23: domains, ranges,
...
- Current frontier:
  ...
  - the Chapter 5 ledger classifies all 59 numbered results: 19 exact and one
    partial so far, consecutive from 5.4 through 5.23, covering formula 5(1),
    Definition 5.4, the characterizations of semicontinuity, the whole
    local-boundedness section, optimal-set mappings, and the projection half
    of 5.23.
